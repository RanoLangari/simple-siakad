...
namespace SiakadSederhana
{
    public partial class FormTambahMataKuliah : Form
    {
        ...
        private void buttonHapus_Click(object sender, EventArgs e)
        {
            if (mataKuliahDipilih != null)
            {
                var mataKiliahYangMauDiHapus = FormMataKuliah.ListMataKuliah.Find(x => x.KodeMataKuliah == mataKuliahDipilih.KodeMataKuliah);

                if (mataKiliahYangMauDiHapus != null)
                {
                    mataKiliahYangMauDiHapus.NamaMataKuliah = textBoxNamaMk.Text;
                    mataKiliahYangMauDiHapus.Deskripsi = textBoxDesripsiMk.Text;
                    mataKiliahYangMauDiHapus.JumlahSks = int.Parse(textBoxJumlahSks.Text);
                    FormMataKuliah.ListMataKuliah.Remove(mataKiliahYangMauDiHapus);
                    MessageBox.Show("Data telah diubah.");
